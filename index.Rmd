...
author: <br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>Dylan Padilla, Dale DeNardo & Michael Angilletta <br/> June, 2022 <br/> `r icon_style(fontawesome("envelope", style = "solid"), scale = 1, fill = "red")` dpadil10@asu.edu | `r icon_style(fontawesome("link", style = "solid"), scale = 1, fill = "red")` https://dylanpadilla.netlify.app/
output:
...
```{r, echo = FALSE, fig.height = 6, fig.width = 7, fig.align = "center", warning = FALSE, comment = " ", message = FALSE}
...
<img src = "images/fat.png"  width = "390" height = "290"><br/>
...
```{r, fig.height = 4, fig.width = 4, comment = " ", message = FALSE, dpi = 190}
...
legend("topleft", legend = c("large female", "small female"), lty = c(4, 1), lwd = c(2, 2), bty = "n", cex = 0.5)
...
legend("topleft", legend = c("sit and wait", "widely foraging"), lty = c(1, 2), lwd = c(2, 2), col = c("skyblue", "purple"), bty = "n", cex = 0.5)
...
legend("topleft", legend = c("sit and wait", "widely foraging"), lty = c(1, 2), lwd = c(2, 2), col = c("skyblue", "purple"), bty = "n", cex = 0.5)
mtext("(c)", at = 0.001, line = 1, cex = 0.7, font = 2)
